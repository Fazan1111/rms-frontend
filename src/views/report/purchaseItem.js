...
import PrintPurchItemReport from "./prints/PrintPurchItem";
            ...
            <this.Space size="small" style={{marginBottom: '15px'}}>
                <div>
                    <div style={{display: 'none'}}>
                        <PrintPurchItemReport data={this.state.data} ref={el => (this.componentRef = el)} />
                    </div>
                ...
                <div>
                    <CSVLink 
                        ...
                        filename={"purchaseItemReport.csv"}
                    >
